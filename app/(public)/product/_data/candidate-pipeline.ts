...
export const candidatePipeline: ProductPage = {
  ...
  meta: {
    title: 'Candidate Pipeline Software for Faster Hiring Workflows | HireSort',
    description:
      'HireSort helps recruiters manage candidate pipelines after resume screening. Track stages, review ranked shortlists, customize funnels, and move candidates from new applicant to hire.',
    keywords: [

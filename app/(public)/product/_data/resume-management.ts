...
export const resumeManagement: ProductPage = {
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: [
        'HireSort is a lightweight early-hiring candidate management system. It includes resume repository, stage tracking, AI screening, AI phone screening, and first-round interview context, but it is not positioned as a full enterprise ATS.',
      ],
    },
    {

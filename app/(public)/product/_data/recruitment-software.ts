...
export const recruitmentSoftware: ProductPage = {
  ...
  sections: [
    ...
    },
    {
      ...
      title: 'Recruitment Software Focused on Early Hiring Workflows.',
      inLabel: 'Focused on',
      inItems: [
        'JD creation',
        'Job posting',
  ...
  faqs: [
    ...
    { id: 'candidate-screening-software', question: 'Is HireSort Candidate Screening Software?', answer: ['Yes. HireSort is candidate screening software that also supports the broader early hiring workflow: sourcing, AI resume screening, phone screening, first-round interviews, and structured shortlists.'] },
    { id: 'high-volume', question: 'Can HireSort Support High-Volume Hiring?', answer: ['Yes. HireSort is designed for bulk resume uploads, automated screening, and structured shortlists, which makes it useful for high-volume hiring workflows where recruiters need to review many applicants quickly.'] },
    { id: 'how-different', question: 'How Is HireSort Different From Traditional Recruitment Software?', answer: ['HireSort focuses on agentic hiring workflows. It helps teams move from role intake to JD creation, posting, sourcing, screening, interviews, and shortlist delivery with less manual recruiting effort.'] },
    { id: 'is-ats', question: 'Is HireSort an ATS?', answer: ['HireSort can act as a lightweight ATS for teams that need resume management, candidate tracking, AI screening, phone screening, first-round interviews, and shortlist workflows. It is not positioned as a full enterprise ATS.'] },
    ...
    { id: 'best-for', question: 'Who Is HireSort Best For?', answer: ['HireSort is best for recruiters, founders, hiring managers, small teams, and recruitment agencies that need faster sourcing support, AI resume screening, early interviews, structured shortlists, and simpler candidate tracking.'] },
    ...
    { id: 'scheduling-offers', question: 'Does HireSort Include Interviews and Offer Management?', answer: ['HireSort supports early candidate screening workflows, including phone screening and first-round interviews. It is not a full HR suite for offer letters, onboarding, payroll, or background checks.'] },
  ],
